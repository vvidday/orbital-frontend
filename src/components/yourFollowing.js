                ...
                if (userFollowing.length > 8) {
                    ...
                    while (i < 8) {
                        const random = Math.floor(
                            Math.random() * userFollowing.length
                        );
            ...
            {following ? (
                <Box marginTop="10px" position="relative" p="0em 1.1em 0em 1.1em">
                    ...
                    <Popover isLazy>
                        <PopoverTrigger>
                            <QuestionIcon
                                aria-label="Your Following Helper"
                                position="absolute"
                                top="0px"
                                right="0px"
                            />
                        ...
                        <Portal>
                            <PopoverContent>
                                ...
                                <PopoverCloseButton />
                                <PopoverBody>
                                    Play a game based on some of the accounts
                                    you are following!
                                </PopoverBody>
                            </PopoverContent>
                        </Portal>
                        ...
                        <Portal>
                            <PopoverContent>
                                ...
                                <PopoverBody>
                                    ...
                                    Unfortunately we are limited by Twitter's
                                    rate limit. Please refresh the page after a
                                    couple of minutes.
                                </PopoverBody>
                                <PopoverBody>
